 ...
 * author mengk
 */
public class MTabLayout extends HorizontalScrollView implements ViewPager.OnPageChangeListener {
...
//                tv_tab_title.setTextSize(TypedValue.COMPLEX_UNIT_PX, i == mCurrentTab ? (int) (mTextSize) : mTextSize);
    ...
    public void setGradientIndicatorDrawable(int drawableId) {
        mIndicatorDrawable=getContext().getResources().getDrawable(drawableId);
